...
![image](https://github.com/user-attachments/assets/8a3cf6a3-65c9-42fc-b504-b50806d0bef5)
...
6. Проверьте файл загрузочной конфигурации:
    ```bash
...
7. Изучите характеристики интерфейса VLAN 1:
    ```bash
   ...
   **Вопрос** Включен ли интерфейс?
   **Ответ:** Интерфейс выключен.
![image](https://github.com/user-attachments/assets/e66490a5-0ce5-4e8d-ac41-523d920e88aa)

8. Подсоедините кабель Ethernet компьютера PC-A к порту 6 на коммутаторе и изучите IP-свойства интерфейса SVI сети VLAN 1.
...
**Ответ:** Подключить консольный кабель на устройстве (на компьютере или на коммутаторе). Проверить состояние интерфейса через команду show interface f0/6 из привилегированного режима
